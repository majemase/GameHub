 ...
 * Use the {@link MisLikesFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class MisLikesFragment extends Fragment {

    private ModeloPublicacion modeloPublicacion;

    public MisLikesFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_mis_likes, container, false);
        RecyclerView publicacionRv = view.findViewById(R.id.misLikes_rv);
